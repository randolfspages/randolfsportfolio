...
const heading = 'Personal Projects'
          ...
          {PROJECTS.map((project, index) => (
            <div key={index} className="mb-12 flex flex-wrap lg:justify-center">
              <motion.div
                ...
                transition={{ duration: 1.5 }}
              >
                <Link to={project.link} target="_blank" className="flex justify-center mt-2">
                  <img
                    src={project.image}
                    width={250}
                    height={250}
              ...
              <motion.div
                className="w-full max-w-xl lg:w-3/4 text-center md:text-start"
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                {project.technologies.map((tech, index) => (
                  <span
                    key={index}
                    className="rounded bg-stone-900 mx-auto p-2 text-center text-sm font-medium text-stone-300"
                  >
                    {tech}
                  </span>
                ))}
